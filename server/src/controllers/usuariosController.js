...
const register = async (req, res) => {
    ...
    try {
        ...
        // Asignar el rol en función del correo electrónico
        const rol = (email === 'friendsCarRent2024@outlook.com') ? 'admin' : 'user';
...
const login = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Inicio de sesión exitoso', username: user.nombreCompleto, userId: user._id, userRol: user.rol });
